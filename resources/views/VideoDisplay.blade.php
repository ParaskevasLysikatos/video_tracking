...
<html lang="{{ app()->getLocale() }}">
    ...
    <br>
                ...
                <video name="video" id="{{$v->upload_name}}" style="alignment: left; display:flow;  margin: 1%;"   width="800px" height="350px" controls src="storage/videos/{{$v->upload_name}}" type="video/mp4" preload="metadata">
